...
router.post('/submit-form', async (req, res) => {
    ...
    const sql = `INSERT INTO personal_info(StudentID,Firstname,Lastname,DOB,Phone) VALUES (?,?,?,?,?)`
    await connection.execute(sql,[id,firstName,lastName,dateOfBirth,phoneNumber])
